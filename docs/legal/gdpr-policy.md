...
- **GitHub Pages (Documentation Site):** The Soleur documentation site at [soleur.dev](https://soleur.dev) is hosted on GitHub Pages. GitHub may collect IP addresses, browser metadata, and other standard web server logs. GitHub acts as the data controller for this data under its own privacy statement.
