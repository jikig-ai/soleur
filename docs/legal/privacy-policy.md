...
**From the Co-Member's perspective.** If you accept an invitation to join a workspace, your activity (conversations you participate in, knowledge-base queries you submit, sends and template authorizations you create under the workspace's grants) is visible to the Workspace Owner and to other Co-Members of the same workspace. The Workspace Owner is the controller of the workspace's data under Terms & Conditions Section 3b.1; your independent rights of access, rectification, erasure, restriction, portability, and objection (Articles 15 through 22 GDPR) against Jikigai over rows identifiable to you are unaffected by your membership in the workspace. A Side Letter between you and the Workspace Owner — using the Soleur Side Letter template (`knowledge-base/legal/side-letter-template.md`) — governs the confidentiality, intellectual-property assignment, and workspace-activity-logged acknowledgement obligations on the Workspace Owner's side.
