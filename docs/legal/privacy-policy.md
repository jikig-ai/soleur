...
> **Related documents:** This Privacy Policy should be read alongside the companion [Cookie Policy](cookie-policy.md) for detailed information about cookies used by the Docs Site (GitHub Pages) and the [GDPR Policy](gdpr-policy.md) for detailed GDPR-specific disclosures.
