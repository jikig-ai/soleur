...
Soleur is a Claude Code plugin providing a full-stack AI organization — specialist agents, skills, and a compounding knowledge base spanning Engineering, Legal, Marketing, Operations and Product — designed for solo founders and technical builders.
