...
- **Soleur** ("Provider," "we," "us," or "our"), the developer and maintainer of the Soleur Claude Code plugin, accessible at [https://soleur.dev](https://soleur.dev) and the GitHub repository [jikig-ai/soleur](https://github.com/jikig-ai/soleur); and
...
Soleur is an open-source project maintained by Jikig AI.
...
**1.8** "Docs Site" means the Soleur documentation website hosted at [https://soleur.dev](https://soleur.dev) via GitHub Pages.
...
- **Website:** [https://soleur.dev](https://soleur.dev)
