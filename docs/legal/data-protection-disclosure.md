...
| Microsoft Ireland Operations Ltd -- Section 2.3(p)(iii) | One-time custody of K-bis business-verification documents at LinkedIn appeal-flow step (KYC-equivalent under LinkedIn Platform Terms) | K-bis extract contents (gérant full legal name, Jikigai SARL registered address, RCS Luxembourg registration number, capital structure metadata); tax registration; registered-address proof | Legal obligation (Article 6(1)(c)) -- LinkedIn Platform Terms business-verification requirement | Microsoft's controller-to-controller transfer terms apply; document custody falls under [Microsoft's EU Data Boundary](https://aka.ms/EUDataBoundary) commitments |
