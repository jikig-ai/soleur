...
- **"Documentation Site"** refers to the website hosted at soleur.dev on GitHub Pages.
...
We reserve the right to modify these Terms at any time. Changes will be posted to the Soleur GitHub repository (jikig-ai/soleur) and/or the documentation site (soleur.dev). Material changes will be communicated through the repository's release notes or changelog.
