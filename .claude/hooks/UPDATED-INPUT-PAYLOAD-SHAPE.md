...
**Issue:** #7165 · **ADR:** [ADR-160](../../knowledge-base/engineering/architecture/decisions/ADR-160-pretooluse-hooks-may-rewrite-tool-input.md)
...
change, not a live requirement. It is still implemented (ADR-160 clause 4).
...
See [ADR-160](../../knowledge-base/engineering/architecture/decisions/ADR-160-pretooluse-hooks-may-rewrite-tool-input.md)
