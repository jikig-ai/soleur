...
**Issue:** #7165 · **ADR:** [ADR-158](../../knowledge-base/engineering/architecture/decisions/ADR-158-pretooluse-hooks-may-rewrite-tool-input.md)
...
change, not a live requirement. It is still implemented (ADR-158 clause 4).
...
See [ADR-158](../../knowledge-base/engineering/architecture/decisions/ADR-158-pretooluse-hooks-may-rewrite-tool-input.md)
