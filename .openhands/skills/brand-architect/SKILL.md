...
**If it exists:** Read the document, present a brief summary of each section, and ask the user: "Which section would you like to update?" listing each `##` section plus "Full refresh" and "Done" as options.
...
Explore the company identity, one question at a time:
...
Ask the user about the visual direction step:

"Would you like to define visual direction (color palette, typography, style)? Options: (a) Yes, text only -- describe visual direction, (b) Skip for now -- add placeholder text."
...
**If "Skip":** Add placeholder text: "Not yet defined. Run brand architect to add visual direction."
