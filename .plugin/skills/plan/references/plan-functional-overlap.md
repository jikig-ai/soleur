...
If the brainstorm document (loaded in Phase 0.5) contains a `## Capability Gaps` section, include the gap descriptions as additional search context when delegating:

Delegate to a `functional-discovery` sub-agent: "Feature description: [feature_description text].
