...
[![Version](https://img.shields.io/badge/version-2.17.0-blue)](https://github.com/jikig-ai/soleur/releases)
...
Soleur currently provides **32 agents**, **8 commands**, and **41 skills** that compound your company knowledge (currently only engineering so far) over time -- every problem you solve makes the next one easier.
