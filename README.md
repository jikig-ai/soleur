...
[![Version](https://img.shields.io/badge/version-2.18.0-blue)](https://github.com/jikig-ai/soleur/releases)
...
Soleur currently provides **33 agents**, **8 commands**, and **41 skills** that compound your company knowledge (currently only engineering so far) over time -- every problem you solve makes the next one easier.
