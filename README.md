...
[![Version](https://img.shields.io/badge/version-2.29.0-blue)](https://github.com/jikig-ai/soleur/releases)
...
Soleur gives a single founder the leverage of a full organization. **47 agents**, **8 commands**, and **46 skills** that compound your company knowledge over time -- every problem you solve makes the next one easier.
