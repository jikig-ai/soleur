...
**Issue:** #739
**Brainstorm:** `knowledge-base/brainstorms/2026-03-19-app-versioning-brainstorm.md`
...
- `knowledge-base/learnings/2026-03-03-serialize-version-bumps-to-merge-time.md` — tag-only versioning architecture
- `knowledge-base/learnings/integration-issues/github-actions-auto-release-permissions.md` — GITHUB_TOKEN cascade limitation
- `knowledge-base/learnings/runtime-errors/2026-02-13-bash-operator-precedence-ssh-deploy-fallback.md` — `{ ...; }` grouping for `|| true`
- `knowledge-base/learnings/2026-02-27-github-actions-sha-pinning-workflow.md` — SHA pinning requirement
