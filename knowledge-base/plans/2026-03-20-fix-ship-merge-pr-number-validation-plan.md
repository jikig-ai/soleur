...
- Security review: #860
- Related learnings:
  - `knowledge-base/learnings/2026-03-19-github-actions-env-indirection-for-context-values.md` (env-indirection already applied)
  - `knowledge-base/learnings/2026-03-20-github-actions-error-annotations-require-runner.md` (`::error::` valid in `run:` blocks)
