...
| `knowledge-base/learnings/2026-03-20-bun-fpe-spawn-count-sensitivity.md` (new) | Learning document with 3-crash-class taxonomy |

## References

- GitHub issue: #860
- Prior learning: `knowledge-base/learnings/2026-03-18-bun-test-segfault-missing-deps.md` (Bun crash class 1: missing deps)
- Prior learning: `knowledge-base/learnings/2026-03-20-bun-segfault-leaked-setinterval-timers.md` (Bun crash class 2: timer leaks)
