...
- `knowledge-base/learnings/2026-03-18-stop-hook-toctou-race-fix.md` -- TOCTOU defense patterns (apply to new code paths)
- `knowledge-base/learnings/2026-03-18-stop-hook-jq-invalid-json-guard.md` -- jq guard patterns (no new jq calls, but validates existing guards)
