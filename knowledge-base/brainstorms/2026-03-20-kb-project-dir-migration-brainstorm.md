...
knowledge-base/
  project/
    brainstorms/   (moved from knowledge-base/brainstorms/)
    specs/         (moved from knowledge-base/specs/)
    learnings/     (moved from knowledge-base/learnings/)
    plans/         (moved from knowledge-base/plans/)
  audits/          (stays)
  community/       (stays)
  design/          (stays)
  marketing/       (stays)
