...
| Product announcements | Confident, concrete | "30 agents. Every department. From idea to shipped." |
...
- Use concrete numbers when available (30+ agents, 39+ skills)
...
- Call it a "plugin" or "tool" in public-facing content -- it is a platform
