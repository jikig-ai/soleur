...
| Issue | Action | Status |
|---|---|---|
| #7884 | Bring the `app.soleur.ai/health` Better Stack monitor under Terraform and make database unavailability page: a required keyword `"supabase":"connected"` or a sibling readiness monitor. Scope widened and raised to p1 on 2026-09-15 for this incident. | fixed in #8216; live after the post-merge read-back (AC17); #7884 closes with the import-removal PR |
