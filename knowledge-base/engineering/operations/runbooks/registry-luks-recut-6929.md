...
directions on a days timescale (`cx23` in `hel1-dc2`: ✗ 2026-07-26, ✗ 2026-08-04, ✓ 2026-08-06), so a
reading from a previous dispatch authorizes nothing. Measured 2026-08-05: `cx23` was orderable in `nbg1-dc3`
...
- **#7309** — RESOLVED 2026-08-06. `var.registry_server_type` now defaults to `cpx22`.
  ...
  justified the repin is that `cx23` availability there flipped twice in eleven days while `cpx22`
  held at every probe. Left for the record because the original text read:
