...
## Note — ADR-150 (2026-07-28)

**The Decision here is unchanged.** ADR-150 collapsed the AGENTS change-class
...
- The rejected "Eager SessionStart scan" alternative remains rejected. Its
  ...
  `session-rules-loader.sh` SOC 2 evidence path — is *unaffected*: ADR-150
