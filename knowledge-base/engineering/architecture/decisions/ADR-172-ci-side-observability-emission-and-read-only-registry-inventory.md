...
> ADR-182 ships a host-side container-log shipper into `cloud-init-registry.yml` that rides that
...
>
> **§3's write-surface finding is undisturbed.** ADR-182 changes no `accessControl` and grants no
