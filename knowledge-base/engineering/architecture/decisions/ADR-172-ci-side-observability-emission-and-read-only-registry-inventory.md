...
> **Superseded 2026-08-11 (#7440), by ADR-179 §7 — the premise above no longer holds.** The body of
...
> ADR-179 ships a host-side container-log shipper into `cloud-init-registry.yml` that rides that
...
>
> **§3's write-surface finding is undisturbed.** ADR-179 changes no `accessControl` and grants no
