---
title: "ADR-246: Host root disks are ledgered stores"
status: accepted
date: 2026-09-23
issue: 8532
supersedes: []
...
# ADR-246: Host root disks are ledgered stores
...
Inngest server's root-disk posture in its description (ADR-247 owns the clause convention).
