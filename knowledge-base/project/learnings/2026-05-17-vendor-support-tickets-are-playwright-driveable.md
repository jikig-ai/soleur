...
- Ticket drafts file (updated to reflect submitted state): `knowledge-base/engineering/operations/runbooks/sentry-support-ticket-drafts.md`
- PIR Phase 8 Gate 3 anchor: `knowledge-base/engineering/operations/post-mortems/sentry-phantom-ingest-destination-unreachable-postmortem.md`
