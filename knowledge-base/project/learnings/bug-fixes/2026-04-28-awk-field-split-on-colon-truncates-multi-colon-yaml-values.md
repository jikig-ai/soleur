---
title: '`awk -F'': ''` Truncates Multi-Colon YAML Values; `sub(/^X|X$/)` Only Fires Once'
date: 2026-04-28
category: bug-fixes
tags: [awk, mawk, github-actions, yaml, frontmatter, dedup, campaign-calendar]
symptoms: [campaign-calendar dedup search files duplicates against existing open audits, Issue titles truncated at first inner colon (e.g., 'Show HN: ...' → 'Show HN'), Issue titles carry a trailing quote artifact ('Browsers"' instead of 'Browsers')]
module: ci-workflows
