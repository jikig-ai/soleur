...
- [`2026-07-16-a-mutation-battery-only-covers-what-you-mutate.md`](./2026-07-16-a-mutation-battery-only-covers-what-you-mutate.md) — same thesis, three days earlier; this is an independent recurrence in a different subsystem
