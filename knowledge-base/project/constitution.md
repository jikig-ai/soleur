...
- For user-facing pages with a Product/UX Gate, specialists (ux-design-lead, copywriter) must produce artifacts before implementation -- code implements from approved artifacts, not brainstorm notes. (ex-`wg-for-user-facing-pages-with-a-product-ux`)
