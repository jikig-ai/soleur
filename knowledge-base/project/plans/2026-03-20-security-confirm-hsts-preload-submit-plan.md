...
2. Update the learning at `knowledge-base/project/learnings/2026-03-20-nextjs-static-csp-security-headers.md` to note the preload submission (the learning currently shows `max-age=63072000; includeSubDomains` without `preload` in the headers table)
...
- [x] `knowledge-base/project/learnings/2026-03-20-nextjs-static-csp-security-headers.md` HSTS table entry updated to include `preload`
...
### `knowledge-base/project/learnings/2026-03-20-nextjs-static-csp-security-headers.md` (update)
...
- Related learning: `knowledge-base/project/learnings/2026-03-20-nextjs-static-csp-security-headers.md`
