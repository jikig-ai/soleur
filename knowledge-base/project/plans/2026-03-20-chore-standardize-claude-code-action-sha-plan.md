...
Found during security review of #803. Pre-existing issue noted in `knowledge-base/project/plans/2026-03-19-fix-ci-pr-based-commit-pattern-plan.md` line 209.
...
The `security_reminder_hook.py` PreToolUse hook blocks both Edit and Write tools on `.github/workflows/*.yml` files. All workflow edits must use `sed` via the Bash tool. See learning: `knowledge-base/project/learnings/2026-03-18-security-reminder-hook-blocks-workflow-edits.md`.
...
- Prior observation: `knowledge-base/project/plans/2026-03-19-fix-ci-pr-based-commit-pattern-plan.md` (line 209)
- Learning (hook constraint): `knowledge-base/project/learnings/2026-03-18-security-reminder-hook-blocks-workflow-edits.md`
- Learning (digest pinning analog): `knowledge-base/project/learnings/2026-03-19-docker-base-image-digest-pinning.md`
- Learning (version pinning analog): `knowledge-base/project/learnings/2026-03-19-npm-global-install-version-pinning.md`
