...
- `knowledge-base/project/learnings/2026-03-19-docker-base-image-digest-pinning.md` -- consider adding digest pin in follow-up
- `knowledge-base/project/learnings/2026-03-19-npm-global-install-version-pinning.md` -- `@anthropic-ai/claude-code@2.1.79` is already pinned
- `knowledge-base/project/learnings/2026-03-19-docker-healthcheck-start-period-for-slow-init.md` -- healthcheck `--start-period` pattern
