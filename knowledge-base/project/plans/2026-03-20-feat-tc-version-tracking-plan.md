...
Per the learning in `knowledge-base/project/learnings/2026-03-20-supabase-trigger-fallback-parity.md`, the database trigger and the TypeScript fallback in `callback/route.ts` must use identical conditional logic for `tc_accepted_version`. Both must:
...
- `knowledge-base/project/learnings/2026-03-20-supabase-trigger-fallback-parity.md` -- trigger/fallback parity learning
- `knowledge-base/project/learnings/2026-03-20-supabase-column-level-grant-override.md` -- column-level GRANT learning
