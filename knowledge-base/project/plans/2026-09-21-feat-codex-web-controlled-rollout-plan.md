...
| Credential and data policy | Auth boundary and fail-closed egress policy exist but production composition is absent | Select an account/workspace-scoped lease from Web settings, bind auth mode, and recheck egress at execution and lifecycle boundaries |
