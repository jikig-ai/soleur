...
> **Migration renumbered 114 → 115 at /work (2026-06-30):** a sibling PR landed `114_disk_io_top_wal_statements` on origin/main mid-session (the fast-moving-main hazard the collision gate guards). All "114" references below now mean **115** (`115_worktree_write_lease`).
