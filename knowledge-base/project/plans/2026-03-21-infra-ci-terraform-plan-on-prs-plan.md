...
- Closes #975
- Depends on #978
- Plan: `knowledge-base/project/plans/2026-03-21-feat-terraform-state-r2-migration-plan.md` (Phase 6, deferred)
- Learning: `knowledge-base/project/learnings/2026-03-21-terraform-state-r2-migration.md` (session error #4 -- tf-var backend conflict)
- Learning: `knowledge-base/project/learnings/2026-03-21-doppler-tf-var-naming-alignment.md`
- Learning: `knowledge-base/project/learnings/2026-03-20-ci-deploy-reliability-and-mock-trace-testing.md` (concurrency group patterns)
