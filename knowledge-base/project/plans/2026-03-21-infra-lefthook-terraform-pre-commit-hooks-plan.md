...
- Parent plan: `knowledge-base/project/plans/2026-03-21-feat-terraform-state-r2-migration-plan.md` (Phase 4 item 2)
- Existing lefthook config: `lefthook.yml`
- Terraform files: `apps/telegram-bridge/infra/*.tf`, `apps/web-platform/infra/*.tf`
- Learning: `knowledge-base/project/learnings/2026-03-21-doppler-tf-var-naming-alignment.md` (notes pre-existing fmt issue)
