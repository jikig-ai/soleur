...
| Migration command: `npx supabase db push` | **Runbook EXPLICITLY forbids npx supabase**. Canonical: `doppler run -p soleur -c dev -- bash scripts/run-migrations.sh` per `knowledge-base/engineering/operations/runbooks/supabase-migrations.md:171` | Phase 0.3, Phase 1.4, Phase 8 use the correct command |
...
- **Supabase migrations runbook:** `knowledge-base/engineering/operations/runbooks/supabase-migrations.md`
