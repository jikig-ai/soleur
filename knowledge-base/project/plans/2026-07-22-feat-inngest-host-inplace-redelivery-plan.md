...
adr: ADR-133 (provisional — re-verify next-free ordinal at ship per the ADR-Ordinal Collision Gate)
---
...
**Phase 1 — ADR-133 + C4 (architectural decision is a deliverable).**
...
### ADR
- **Create ADR-133** (provisional) — pull-based signed config-refresh for the dedicated Inngest host.
