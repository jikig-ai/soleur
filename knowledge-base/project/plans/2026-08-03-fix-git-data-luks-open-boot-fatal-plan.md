...
### Phase 4 — ADR (**ADR-162**; 158 and 159 both collided — see the ordinal note)
...
| Path | Purpose |
|---|---|
| `knowledge-base/engineering/architecture/decisions/ADR-162-birth-filesystem-features-must-be-mountable-by-the-target-image.md` | The birth-filesystem feature-set decision (renumbered 158 -> 159 -> 161 after two mid-branch collisions) |
