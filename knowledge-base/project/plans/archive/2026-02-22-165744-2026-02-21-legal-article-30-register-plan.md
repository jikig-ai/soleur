...
Per the GDPR Article 30 compliance audit (#187, resolved in #200), Jikigai must maintain an internal record of processing activities. The template exists at `knowledge-base/project/specs/archive/20260221-044654-feat-cnil-article-30/article-30-register-template.md` but no tooling exists to:
...
- Learning: `knowledge-base/project/learnings/2026-02-21-gdpr-article-30-compliance-audit-pattern.md`
