...
- [x] AC8 The PR body says `Closes #8361`, carries the measured AC1 number, and contains no dispatch of any workflow; the only post-merge event is the ordinary merge-triggered apply on `main` (which this fix un-breaks).
