...
- Brainstorm: `knowledge-base/project/brainstorms/2026-02-22-finance-domain-brainstorm.md`
- Template: `plugins/soleur/agents/sales/` (4 agents)
- Checklist: `knowledge-base/project/learnings/integration-issues/adding-new-agent-domain-checklist.md`
