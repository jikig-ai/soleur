...
Sections below that reference the bypass actor addition are annotated with strikethrough to preserve planning context. The tasks file (`knowledge-base/project/plans/2026-03-19-chore-cla-ruleset-integration-id-tasks.md`) reflects the actual outcome.
