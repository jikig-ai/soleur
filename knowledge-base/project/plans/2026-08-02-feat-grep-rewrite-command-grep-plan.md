...
|---|---|---|
| ADR-155 (provisional) | 155, 156 **and** 157 landed on `main` before this branch rebased | **ADR-161**; swept across plan, tasks, ACs, README, C4 (task 7.8) |
...
| AC8: identical stdout | **Not identical.** Four divergence classes, measured against real ugrep | Enumerated in ADR-161 §Accepted divergences |
...
accepted in ADR-161. **The `.gitignore` one carries a privacy dimension the plan
