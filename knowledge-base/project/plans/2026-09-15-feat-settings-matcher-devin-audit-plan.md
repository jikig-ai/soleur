...
- [ ] AC11: Diff-scope: the PR touches only the Files-to-Create/Edit list plus pipeline artifacts (`knowledge-base/INDEX.md`, spec-dir session state).
