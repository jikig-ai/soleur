...
- Refactoring `worktree-manager.sh` -- it has its own inline detection pattern with additional worktree-of-bare-repo logic that goes beyond what `resolve-git-root.sh` provides
