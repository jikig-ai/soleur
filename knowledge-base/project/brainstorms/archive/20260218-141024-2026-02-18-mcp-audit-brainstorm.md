...
**Constraint:** Only HTTP MCP servers are considered. Stdio servers can't be bundled in plugin.json and require separate IDE extension installation (documented in `knowledge-base/project/learnings/2026-02-14-pencil-mcp-local-binary-constraint.md`).
