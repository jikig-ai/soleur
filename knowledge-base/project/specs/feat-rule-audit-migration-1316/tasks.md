...
- [ ] 2.1 Add --delete-branch rule to constitution.md Architecture > Never section (with hook tag and rationale)
...
## Phase 3: Update Hook Script Comments

- [ ] 3.1 Update guardrails.sh header: Guards 1, 2, 3, 5 now reference constitution.md instead of AGENTS.md
- [ ] 3.2 Update pre-merge-rebase.sh header: Remove AGENTS.md references, keep constitution.md reference
