...
- **C7 — Privacy Policy Better Stack disclosure landed as NEW §5.14, NOT §5.11 with renumber.** Plan §5.3 prescribed inserting §5.11 with renumber of §5.11→§5.12→§5.13. Renumbering would have touched 7+ cross-ref sites across `docs/legal/gdpr-policy.md`, `knowledge-base/legal/compliance-posture.md`, `knowledge-base/legal/audits/2026-05-counsel-review-4051.md`, `knowledge-base/engineering/operations/runbooks/cla-signature-evidence-retrieval.md`, `knowledge-base/legal/article-30-register.md`, the mirror in `plugins/soleur/docs/pages/legal/privacy-policy.md`, and two adjacent plans. The disclosure's load-bearing attributes are the operator/role/region/transfer-mechanism/pseudonymisation paragraph, NOT the section ordinal. Appended at §5.14 in both source and mirror — same DPD parity contract as the original plan.
