...
- [ ] 1.1.1 Generate SHA-256 hashes for `google-genai==1.66.0` and `Pillow==11.3.0`
...
- [ ] 1.1.4 Test: `pip install --require-hashes -r requirements.txt` succeeds in a clean venv
...
- [ ] 1.3.3 Configure: `fail-on-severity: high`, `license-check: true`, `vulnerability-check: true`
- [ ] 1.3.4 Verify: trigger workflow on a test PR
...
- [ ] 1.4.4 Verify: `bun install` still works locally with the new settings
