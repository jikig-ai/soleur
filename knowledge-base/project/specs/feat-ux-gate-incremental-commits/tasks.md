...
- [x] 1.1 Read current `/soleur:work` SKILL.md to confirm exact line locations for edits
  - Check 9 at line 81, Design Artifact Gate at line 184, Incremental Commits at lines 207-235

## Phase 2: Core Implementation

- [x] 2.1 Add post-specialist commit checkpoint to Phase 0.5 check 9 (specialist review checks)
...
- [x] 2.2 Add post-Design-Artifact-Gate commit checkpoint to Phase 2 step 2
...
- [x] 2.3 Extend incremental commit heuristic table in Phase 2 step 3
...
- [x] 3.1 Run markdownlint on modified SKILL.md
- [x] 3.2 Re-read SKILL.md to verify all three commit checkpoints are in place
- [x] 3.3 Verify existing Phase 2.3 table formatting preserved (pipe alignment, column spacing)
- [x] 3.4 Verify compound exemption text is present in all three insertion points
