...
- **TR4 — No GDPR-gate trigger.** This change adds documentation + threshold rules; it does not write to or read from regulated data surfaces. Confirm at plan time that `hr-gdpr-gate-on-regulated-data-surfaces` does not fire.
