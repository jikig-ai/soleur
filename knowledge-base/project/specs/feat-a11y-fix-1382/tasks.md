...
- [ ] 1.13 Replace `text-neutral-600` with `text-neutral-400` in `apps/web-platform/app/(dashboard)/dashboard/chat/[conversationId]/page.tsx` (lines 174, 265)
- [ ] 1.14 Replace `text-neutral-600` with `text-neutral-400` in `apps/web-platform/app/(dashboard)/dashboard/page.tsx` (lines 132, 165)
- [ ] 1.15 Replace `text-neutral-600` with `text-neutral-400` in `apps/web-platform/components/chat/at-mention-dropdown.tsx` (line 117)
- [ ] 1.16 Replace `text-neutral-600` with `text-neutral-400` in `apps/web-platform/app/(auth)/connect-repo/page.tsx` (lines 641, 800)
- [ ] 1.17 Replace `placeholder:text-neutral-400` with `placeholder:text-neutral-400` in `apps/web-platform/components/settings/key-rotation-form.tsx` and `delete-account-dialog.tsx`
