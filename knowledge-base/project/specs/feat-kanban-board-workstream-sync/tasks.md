...
- [ ] A.1 Create ADR-075 (re-confirm next free number; main max ADR-074) — board-canonical Decision + Alternatives (webhook-ingress deferred, app-labels rejected, PAT rejected)
