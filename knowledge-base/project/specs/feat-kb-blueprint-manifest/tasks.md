...
- [x] Every generated **`.c4`** file carries `// GENERATED by /soleur:sync c4 — hand edits
      will be overwritten`. `c4-model.md` (markdown) and `model.likec4.json` (JSON) cannot
      carry it and are protected differently — O_EXCL seeding and off-tree-render-then-publish
      respectively. The uniform "every file it writes" claim was corrected at review.
