...
- [x] 1.2 Add Section 5.3 to `plugins/soleur/docs/pages/legal/data-protection-disclosure.md`
  - [x] 1.2.1 Insert identical Section 5.3 content
  - [x] 1.2.2 Adjust links to HTML paths (`/pages/legal/gdpr-policy.html`)
  - [x] 1.2.3 Update "Last Updated" date in hero section and document header

## Phase 2: Verification

- [x] 2.1 Cross-file consistency check: verify both DPD files have identical legal content (differing only in link format)
- [x] 2.2 Cross-document consistency check: verify Section 5.3 data categories match Section 2.1b
- [x] 2.3 Verify no section numbering conflicts (Section 6 still follows Section 5)
- [x] 2.4 Run markdownlint on both files
