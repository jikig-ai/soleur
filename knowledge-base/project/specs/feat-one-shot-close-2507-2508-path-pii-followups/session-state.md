...
### Decisions
- Two new runbooks (`plausible-pii-erasure.md`, `plausible-dashboard-filter-audit.md`) under `knowledge-base/engineering/operations/runbooks/` — one-file-per-vendor per existing pattern.
