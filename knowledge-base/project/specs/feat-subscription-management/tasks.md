...
- [x] 2.1 Create `/api/billing/portal` route
...
- [x] 3.1 Create billing section component
...
- [x] 3.2 Create retention modal component
...
- [x] 3.3 Add billing data + stats to Settings server component
...
- [x] 3.4 Add billing section to `SettingsContent`
...
- [x] 4.1 Write tests:
  - [x] 4.1.1 Billing section component tests
        (`apps/web-platform/test/billing-section.test.tsx`)
  - [x] 4.1.2 Portal route tests
        (`apps/web-platform/test/api-billing-portal.test.ts`)
  - [x] 4.1.3 Webhook handler tests for new events
        (`apps/web-platform/test/webhook-subscription.test.ts`)
  - [x] 4.1.4 Verify agent env isolation
        (`apps/web-platform/test/agent-env.test.ts`)
- [x] 4.2 Run CSRF coverage test to verify `/api/billing/portal` is detected
