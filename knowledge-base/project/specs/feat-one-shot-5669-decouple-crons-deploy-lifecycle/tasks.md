...
- [ ] 6.1 Create ADR-076 via /soleur:architecture (Decision, Alternatives w/ Option-2 deferred + re-eval (a)-(e), named loosening trade-offs, C4 no-impact enumeration).
- [ ] 6.2 File Option-2 (isolated cron-worker) tracking issue with ADR-076 re-eval criteria; verified-existing label.
