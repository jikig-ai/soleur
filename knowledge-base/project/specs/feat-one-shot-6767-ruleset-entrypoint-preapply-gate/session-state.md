...
### Decisions
- Premise correction (major): Deliverable (1) ADOPTION already merged via #6746 (e567792fa) — import block, adopted Flexible SSL rule, and two-rule test pin all shipped. Plan builds only the pre-apply gate + retrospective audit + ADR-133/C4.
