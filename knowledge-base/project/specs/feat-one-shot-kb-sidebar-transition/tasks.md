...
- [x] 2.2 Keep the existing `pl-10` only when `collapsed` is true; expanded
       state has no extra left padding (sidebar provides it via its right border).

## Phase 3 — Tests

- [x] 3.1 Create `apps/web-platform/test/kb-sidebar-transition.test.tsx` with
