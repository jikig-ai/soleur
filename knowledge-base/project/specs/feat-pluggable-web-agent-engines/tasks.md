...
- [ ] RED-05: API-key and managed ChatGPT login isolation, refresh, logout, revoked credentials, approvals, recovery, usage, and cancellation.
  ...
  - [x] Observability slice: dispatch start/progress/completion/failure, reconciliation, and unsupported replay-item drops emit safe metadata through a non-throwing structured sink (4 observability tests and dispatch coverage green).
