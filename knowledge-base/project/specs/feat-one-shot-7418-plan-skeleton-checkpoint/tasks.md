...
ADR: **ADR-175** (provisional; re-verify at ship — ADR-173 is triple-claimed on pushed branches)
...
- [x] 4.5 Author `ADR-175-*.md`, `status: accepted`, with an `amends: [ADR-015]` edge (not a rewrite —
