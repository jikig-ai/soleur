...
emits those frames; a corresponding persisted-binding routine bridge now emits
neutral events for Inngest consumers. Direct handler/Inngest call-site wiring,
managed authorization, qualification, legal disposition, and rollout remain open.
