...
- [ ] 1.2 Re-probe the ADR-239 ordinal across all `origin/*` refs.
...
- [ ] 2.8 ADRs + C4
  - [ ] 2.8.1 ADR-239 (retirement, vendor-CLI CI policy and pin owner, Devin wait primitive, gate map), written with `soleur:architecture`
