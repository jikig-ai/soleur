...
### Decisions
- Combine throttle (option 2) + retention prune (option 1); throttle is the load-bearing WAL lever. `user_concurrency_slots_sweep` `*/15`→hourly cuts total cron runs ~128→~56/day. Both in migration 114.
