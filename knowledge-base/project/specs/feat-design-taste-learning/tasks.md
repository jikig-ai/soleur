...
- [x] 6.1 Author `ADR-087-context-keyed-taste-profile-and-agent-surface-injection.md` (rich; full-slug ref to ADR-086-declarative; 3 decisions; flag 086 collision out-of-scope; note fan-out below C4 line)
