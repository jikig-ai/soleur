...
- [ ] 3.5 In `.github/workflows/main-health-monitor.yml`, change the prose "12 fixture suites" to
  "13 fixture suites" (a one-token edit).

## Phase 4: Verification

- [ ] 4.1 Run the new suite and `run-all.sh` (green), Guard 1 mutation rows 1-10 (each RED)
...
- [ ] 4.4 Run `bash plugins/soleur/test/c4-count-parity.test.sh` (green; this backs "no C4
  impact").
- [ ] 4.5 Check AC9: the workflow diff is the new file plus the one-token `main-health-monitor`
