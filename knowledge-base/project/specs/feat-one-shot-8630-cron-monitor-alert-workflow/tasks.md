...
- [ ] 1.2 Guard 2: add rows to `tests/scripts/test-sentry-alert-reference-gate.sh`:
  ...
  Then run it RED.
- [ ] 1.2a Guard 3 rows in `tests/scripts/test-sentry-alert-adoption-guards.sh`: matrix rows 1-6
...
- [ ] 2.1a Guard 3: make `scripts/sentry-monitor-binding-gate.sh` address-aware.
