...
**OPERATOR DECISION (2026-07-23): ADOPTED the recommendation — ship `scope: "/"` with `start_url: "/dashboard"`.** Auth bounces stay in-app. Challenge 1 (scroll-guard): operator kept 5b in this Phase 1 PR. Challenge 2: keep per audit. Wireframe signed off.
