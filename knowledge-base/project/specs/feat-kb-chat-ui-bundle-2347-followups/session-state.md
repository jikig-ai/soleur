...
- Used existing runbook path `knowledge-base/engineering/operations/runbooks/supabase-migrations.md` (matches existing runbook convention) rather than the issue-suggested `knowledge-base/project/runbooks/`.
