...
- [x] 2.4 CI evidence: a tag build is pullable + signed from zot — **post-provisioning (needs live zot + a tag build)** **Done — evidence:** `IMAGE_VERIFY: ok` against a zot ref on the first deploy after #8543's apply (2026-09-22 12:27:41Z, host `3f07b655`); #8037's `cosign-verify-live-8037.sh` follow-through PASSed on it and the sweeper closed #8037 at 12:58Z. That is a tag build pulled and signature-verified from zot.
