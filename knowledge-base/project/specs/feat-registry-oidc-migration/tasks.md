...
- [ ] 5.3b (post-soak) remove the two cloud-init.yml fresh-boot GHCR branches; ~~stop GHCR push~~ (dropped 2026-09-24, `DECISION: B3`); remove GHCR egress allow — **not done**. Its three parts have different blockers (split 2026-09-24):
  ...
  - [x] ~~5.3b-ii stop GHCR push~~ — **dropped 2026-09-24 by operator `DECISION: B3`** (#6122): CI keeps pushing to GHCR as ADR-169's restore source. See ADR-096 "Amendment 2026-09-24 (#6122)".
