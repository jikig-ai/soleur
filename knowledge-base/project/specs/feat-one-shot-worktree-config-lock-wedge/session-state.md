...
- Two root-of-recurrence docs added: canonical ADR-098 git-surface-topology + budget-gated AGENTS caveat (B_ALWAYS 22995/23000 — core edits must be net-byte-neutral).
