...
- [ ] 2.4 B10: edit steps 4, 5 and 7 and `### Empty Case`. Add the one clause in
...
- [ ] 2.6 B12b: append `Render the HOW THE SKILLS FIT TOGETHER map verbatim.` to the Codex bullet
