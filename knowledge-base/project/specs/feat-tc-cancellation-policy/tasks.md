...
- [ ] 1.1 Insert new Section 5 "Subscriptions, Cancellation, and Refunds" in `docs/legal/terms-and-conditions.md` after line 78
  - [ ] 1.1.1 Write 5.1 Billing and Renewal
  - [ ] 1.1.2 Write 5.2 Cancellation
  - [ ] 1.1.3 Write 5.3 Account Deletion with Active Subscription
  - [ ] 1.1.4 Write 5.4 EU Right of Withdrawal (Art. 16(m) waiver)
  - [ ] 1.1.5 Write 5.5 Refunds (discretionary)
- [ ] 1.2 Renumber sections 5-16 → 6-17 (all `## N.` and `### N.X` headings)
- [ ] 1.3 Update 6 internal cross-references (see plan for line-by-line table)
- [ ] 1.4 Add forward reference in Section 4.3 to new Section 5
- [ ] 1.5 Add subscription deletion reference in Section 14.1b (formerly 13.1b) to Section 5.3
- [ ] 1.6 Update survival clause in Section 14.3 (formerly 13.3)
...
- [ ] 3.2 Grep for stale section references (any reference to old section numbers)
