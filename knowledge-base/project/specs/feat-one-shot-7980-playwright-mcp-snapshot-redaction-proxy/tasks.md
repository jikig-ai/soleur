...
- [x] 1.5 Drive every RED row against the pre-fix stub/proxy and record the observed RED in `phase-0-measurement.md` (QG5). *Record: `runs/suite-red-passthrough.log` (81 passed / 83 failed against `fake-passthrough-proxy.py`), summarised in `phase-0-measurement.md`.*
