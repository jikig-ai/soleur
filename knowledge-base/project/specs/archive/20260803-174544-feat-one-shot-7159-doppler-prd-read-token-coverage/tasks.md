...
- [ ] 0.3 Confirm `ADR-163` is still the next free ordinal against a freshly fetched
...
- [ ] 5.2 One-line premise corrections: `apps/web-platform/infra/tunnel.tf:277`,
      ...
      arguments.
- [ ] 5.3 Write `ADR-163`. Provenance cites the 2026-08-02 census and the 2026-08-03 probes,
