...
- [ ] Write ADR and update/regenerate C4 for implemented boundaries.
  - [x] ADR-224 records persisted binding authority, adapter lifecycle, registry qualification, and the remaining service-identity consequence (renumbered from ADR-223 on 2026-09-17 after the main merge).
