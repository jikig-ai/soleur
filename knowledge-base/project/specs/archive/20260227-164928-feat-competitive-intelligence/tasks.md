...
- [x] `plugins/soleur/README.md` -- update agent/skill counts and tables
- [x] `.claude-plugin/marketplace.json` -- match version
- [x] Root `README.md` -- version badge
- [x] `.github/ISSUE_TEMPLATE/bug_report.yml` -- placeholder
...
- [x] All files use correct frontmatter fields
- [x] Disambiguation sentences present in both directions (new agent references siblings, siblings reference new agent)
