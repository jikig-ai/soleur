...
- **[Erratum, 2026-09-04 (#7772) — appended, not amended.** The bullet above described PA-8's balancing as "mitigated by access scoping and short retention". That was true of the Better Stack estate on 2026-08-12, when one source with a 3-day window carried the whole plane. From 2026-09-03 a second source (`2734275`, `soleur-git-data-prd`) carries a 90-day window. **This review's conclusion is UNDISTURBED** — the git-data stream's mitigation is source-side redaction, not retention (Art. 30 PA-8 §(g), #6982) — but "short retention" is no longer true of the plane as a whole and is scoped per source in the register as of this date. No determination of this audit is reopened.]**
