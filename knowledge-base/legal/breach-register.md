...
live.** All **sixteen** rows below are *assessed and outside* the inclusion predicate (the count was last restated 2026-09-14, #7980; an earlier revision read "thirteen" against a table that already held fifteen). An earlier
