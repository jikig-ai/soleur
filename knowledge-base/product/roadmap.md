...
| Phase 4 (Validate + Scale) | In progress. 88 open, 207 closed (milestone; re-derived from the live API 2026-08-11). Marketing Gate complete: all M1-M63 closed (2026-06-08) — gate cleared. Multi-User Readiness Gate: MU1-MU3 all closed; MU4 (#4229) closed 2026-05-21 (FLAG_TEAM_WORKSPACE_INVITE flag gate pending); MU4.1 PR-A (#4290) and PR-B (#4508) both merged. **Active user onboarding began 2026-08-06** — row 4.1 recruitment underway with alpha tester #1 (Skouer) recorded against #1439 on the self-hosted CLI plugin; per-tester process at `knowledge-base/engineering/operations/runbooks/alpha-tester-onboarding.md`. Remaining open: Phase 4 core validation issues (#1439 recruit founders — 1 of 10, #1440 problem interviews, #1441 guided onboarding, #1442 usage tracking, #1443 exit interviews), #673 container isolation/monitoring, #2004 agent work visualization, #2719 skill security scan, plus internal engineering-tooling work. Internal-tooling issues live in Phase 4 milestone for sequencing but are not customer-facing roadmap rows. |
...
| Post-MVP / Later | 1008 open, 1554 closed (re-derived from the live API 2026-08-11). (+5 competitive-parity bets CP1-CP5 vs Viktor, intake 2026-05-30) |
