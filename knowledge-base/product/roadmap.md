...
| Phase 3 (Make it Sticky) | Near-complete. 3 open, 169 closed (milestone). All roadmap table features shipped. Remaining: QA gate (#2108) + two unlisted milestone issues (#3244 Command Center runtime, #3205 T&C consent — deferred-scope-out). Previously "Not started" items (#1944, #2341, #2342, #2344, #2550, #2662) confirmed closed. Agent work visualization (#2004) moved to Phase 4. KB chat sidebar (#2345) shipped PR #2347. |
| Phase 4 (Validate + Scale) | In progress. 54 open, 72 closed (milestone). Marketing Gate substantially complete (27 of 53 items closed — M17-M22 confirmed done 2026-05-11). Multi-User Readiness Gate complete (MU1-MU3 all closed). Remaining open: M3 (#1051 marketing strategy), M4 (#1445 recruitment templates), M23-M25, M41-M53, Phase 4 core validation issues, plus internal engineering-tooling work. Internal-tooling issues live in Phase 4 milestone for sequencing but are not customer-facing roadmap rows. |
...
| Post-MVP / Later | 471 open, 666 closed. |
| Beta users | 0 |
...
| 4.7 | Plan-based agent concurrency enforcement (slot limits per subscription tier) | P1 | Before public launch | [#1162](https://github.com/jikig-ai/soleur/issues/1162), [#673](https://github.com/jikig-ai/soleur/issues/673) Partial (#1162 closed; umbrella #673 open) |
| 4.8 | Resource monitoring (host CPU/RAM + concurrent session count; per-workspace cgroup accounting deferred to 4.6 container work) | P2 | Before beta invites | [#1052](https://github.com/jikig-ai/soleur/issues/1052), [#673](https://github.com/jikig-ai/soleur/issues/673) Partial (#1052 closed; umbrella #673 open) |
