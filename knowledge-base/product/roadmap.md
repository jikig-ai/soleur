...
| Post-MVP / Later | 699 open, 1316 closed. (+5 competitive-parity bets CP1-CP5 vs Viktor, intake 2026-05-30) |
| Beta users | 0 |
...
CPO weekly review 2026-07-07 (scheduled cron audit): milestone counts synced — Phase 4 (43→44 open, 160 closed unchanged), Post-MVP (710→699 open, 1283→1316 closed; net churn from ~33 issues closed and ~22 new issues opened since 2026-07-06). Re-verified all Phase 4/5 "Not started" roadmap rows (#1439-#1443, #673, #2719, #1423/#1425/#1427/#1428/#1429/#2625, Post-MVP L8-L24 #2556-#3178, CP1-CP5 #4671-#4670) against live issue state: all still open, 0 new STALE_STATUS found. Priority mismatches unresolved since 2026-06-30: #673 and #2719 remain `priority/p2-medium` vs roadmap P1 (Phase 4.6/4.8/4.9 and 4.11) — re-flagged for human review. Full Phase 4 milestone (44 open issues) re-audited for staleness: no new candidates: the 2026-07-06 flagged set (#2004, #2676, #2846, #2640, #3691, #3814, #3416/#3414/#3204, #673/#2719/#3117/#3106/#3789/#4815/#2841/#2599-#2603) persists unchanged (ages +1 day), still none closed for the same protection reasons. 0 MISSING_ISSUE, 0 EMPTY_MILESTONE violations (every phase-table feature has a linked issue; Phase 4/5/Post-MVP all have ≥1 open issue). Post-MVP's 699 open issues were not individually re-audited for staleness beyond the tracked set above (same bounded scope as prior reviews) — a full sweep of the Post-MVP backlog remains undone; flagging this coverage gap rather than silently claiming full coverage. Next review 2026-07-14._
