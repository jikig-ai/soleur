...
|------|----------------|---------------|----------|--------|
| **Soleur vs. Anthropic Cowork** | soleur vs cowork, claude code plugin vs cowork, AI agent platform comparison | Commercial | P1 | Cowork is the #1 competitive threat. Founders choosing between Soleur and free Cowork plugins need a clear comparison. |
| **Soleur vs. Notion Custom Agents** | soleur vs notion ai, AI agents for solo founders vs notion, company as a service vs notion | Commercial | P1 | Notion 3.3 Custom Agents (Feb 24, 2026) is the highest Tier 3 convergence risk. 35M+ Notion users may see Custom Agents as CaaS. |
| **Soleur vs. Cursor** | soleur vs cursor, AI coding agents comparison, claude code plugin vs cursor | Commercial | P2 | "I already use Cursor" is the most common objection. Need clear "and" positioning. |
...
| Competitor | What to Watch | Trigger for Action | Current Status |
|------------|--------------|-------------------|----------------|
| **Anthropic Cowork** | Blog posts, plugin announcements, CaaS positioning | Anthropic uses "Company-as-a-Service" or equivalent framing, or adds persistent memory | No CaaS framing detected. Engineering plugins launched Feb 24. |
| **Notion** | Custom Agents updates, engineering agent announcements, solo-founder positioning | Notion adds engineering agents or positions Custom Agents for solo founders | Custom Agents launched Feb 24. Workspace-scoped. No solo-founder targeting yet. |
| **Tanka** | Agent Store expansion, engineering agents, pricing announcements | Tanka adds engineering agents or launches paid pricing | Agent Store planned. Fundraising agent launched. No engineering or pricing yet. |
| **Cursor** | Multi-domain features, business workflow agents | Cursor expands beyond engineering | No signal. Engineering-only. |
| **SoloCEO** | Product launch, execution capabilities, pricing | SoloCEO moves from advisory to operational execution | Beta 2026. Advisory-only. |
...
_Generated: 2026-03-03. Sources: content-audit.md (2026-02-19), content-plan.md (2026-02-19), competitive-intelligence.md (2026-03-02)._
