...
| Your Roadmap Can't Tell Undecided from Forgotten | Retrospective / methodology | 1,500-2,000 | P3 | Blog within 2 weeks of PR #8536 merging (one with-merge tweet via feature-tweet leading with the 30-of-118 bug; no other with-merge distribution). Issue #8548. Hook: our own `product-roadmap next` saw 30 of 118 open issues (the `gh issue list` default limit) and recommended the wrong phase with no warning. Angle: every known piece of work lives in one of four places (phase row, Post-MVP, Not Yet Specified, Out of Scope closed as not planned); anything else was forgotten. Frame as the retrospective for all five mattpocock/skills audit bundles (MIT, attributed), not this PR alone. Audience: solo founders and technical PMs who plan in GitHub Issues. CTA: `product-roadmap next --frontier`. Channels: blog; X thread; HN/Reddit only for the retrospective; Discord one-line changelog. |
...
| Within 2 weeks of PR #8536 merging | Draft "Your Roadmap Can't Tell Undecided from Forgotten" retrospective covering all five mattpocock/skills audit bundles (Issue #8548, Pillar 2 methodology lane, P3). Sources: PR #8536 body + the 2026-09-22 roadmap-graph learning + NOTICE Bundles 1-5 + the mattpocock/skills audit record in `knowledge-base/product/competitive-intelligence.md` (link the `#reconciliation-status-2026-09-23` anchor, not the file top). No star count; no competitive comparison. One with-merge tweet only; HN/Reddit only for the retrospective. | 3-4 | Draft |
