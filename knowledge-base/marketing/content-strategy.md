...
| Oct 2-9 (post-PR #8301 merge +5-7d, and >=14d after #8100 publishes) | Draft "Your AI Workflow Has a State Machine. Nobody Is Enforcing It." methodology post-mortem (Issue #8326, Pillar 2 incident/methodology lane, P1). Sources: ADR-225 + classifier script. No with-merge distribution; HN only if #8100 did not take the fortnight's slot. | 6-8 | Draft |
