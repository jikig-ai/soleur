...
- [ ] 1.2 Renumber existing steps: Content Audit (1), AEO Audit (2), Content Plan (3->4), GitHub Issue (4->5), Persist (5->6)
- [ ] 1.3 Insert new Step 3 (Technical SEO Audit) between AEO Audit and Content Plan
...
- [ ] 1.4 Update Step 5 (GitHub Issue) to include SEO audit findings summary bullet
- [ ] 1.5 Increase `timeout-minutes` from 45 to 55
- [ ] 1.6 Increase `--max-turns` from 45 to 55 in `claude_args`

## Phase 2: Validation

- [ ] 2.1 Verify the `git add` path in Step 6 already covers the new file (directory glob)
