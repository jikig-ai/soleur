...
- [ ] 1.1 Update `docs/legal/gdpr-policy.md` Section 6 (International Data Transfers)
  - [ ] 1.1.1 Add Buttondown bullet after GitHub bullet: US-based processor, SCCs transfer mechanism, link to Buttondown privacy policy
- [ ] 1.2 Update `docs/legal/gdpr-policy.md` Section 8 (Data Retention)
  - [ ] 1.2.1 Add new subsection 8.3 "Newsletter Subscriber Data": retained until unsubscription, removed from active list on unsubscribe, Buttondown may retain anonymized aggregate data
...
- [ ] 2.1 Update `docs/legal/privacy-policy.md` Section 10 (International Data Transfers)
  - [ ] 2.1.1 Add Buttondown paragraph after Anthropic paragraph: US-based, SCCs, link to Buttondown privacy policy
