...
- [ ] 1.1 Draft Individual CLA (source + Eleventy site copy)
...
- [ ] 1.2 Draft Corporate CLA (source + Eleventy site copy)
...
- [ ] 2.1 Create GitHub gist for CLA signature storage
- [ ] 2.2 Add `PERSONAL_ACCESS_TOKEN` repository secret with gist permissions
- [ ] 2.3 Create CLA Assistant GitHub Action workflow
...
- [ ] 2.4 Smoke test: open throwaway PR to verify action triggers
...
- [ ] 3.2 Update privacy policy (both locations) -- CLA signature data processing, add CLA to Related Documents
- [ ] 3.3 Update data protection disclosure (both locations) -- CLA as processing activity, add CLA to Related Documents
- [ ] 3.4 Update T&C Section 5 (both locations) -- contributor IP framework, add CLA to Related Documents

## Phase 4: Docs Site and Versioning

- [ ] 4.1 Update legal hub page (`legal.njk`) -- add 2 CLA cards, count 7 → 9
- [ ] 4.2 Bump version 3.3.5 → 3.4.0 across all version locations
- [ ] 4.3 Run cross-document consistency audit
