...
- [ ] 2.2 Update `worktree-manager.sh` `create_for_feature()`: spec_dir path (line 152), spec dir creation (lines 181-184), help text (line 194)
...
- [ ] 3.4 Update `compound/SKILL.md`: specs/, learnings/ references
...
- [ ] 3.8 Update `ship/SKILL.md`: specs/, plans/, brainstorms/ references
- [ ] 3.9 Update `merge-pr/SKILL.md`: specs/, plans/ references
...
- [ ] 4.4 Update `sync.md` command: learnings/ references
