...
- [ ] 2.3 Add LinkedIn data collection instructions to the agent prompt Step 2 section, following the X/Twitter bullet pattern
  - [ ] 2.3.1 Include explicit no-post guard ("do NOT post during monitoring runs")
  - [ ] 2.3.2 Include graceful skip for fetch-metrics and fetch-activity stubs
  - [ ] 2.3.3 Instruct agent to log LinkedIn as "enabled (posting only)" in digest platform status
...
- [ ] 3.4 Run compound skill before commit
