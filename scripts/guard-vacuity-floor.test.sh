...
# `apps/web-platform/infra/registry-luks-escrow.test.sh` (#8408 c) — four NEW
# floor-bearing suites in a deferred directory, which would have grown the ledger 47 -> 51 and
