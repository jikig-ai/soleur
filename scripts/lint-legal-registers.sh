...
NOT_TRANSCRIBED=(
  ...
  "knowledge-base/legal/audits/2026-09-03-clo-attestation-7717-art-33-5-register.md | Not a determination: the CLO ATTESTATION of this register (#7791), attested 2026-09-04 under the ship Phase 5.5 Counsel-Review CLO-Attestation Gate. It quotes Art. 4(12) and Art. 33(5) in order to rule on the register's representation of each indexed determination, and so matches the producer pattern, but it assesses no fact pattern and records no controller determination of its own. Same disposition as the counsel-review row above; every future attestation of this register needs the same waiver -- a known cost of scoping the producer to audits/**, not a defect (#7791, #7717)"
