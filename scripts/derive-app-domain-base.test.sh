...
# `x@example.com` makes https://app.x@example.com/health resolve to example.com with `app.x` as
...
assert_malformed "T22 userinfo (@) host relocation"  "x@example.com"      t22
