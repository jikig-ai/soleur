...
SITES=(
  ...
  "plugins/soleur/skills/plan/references/plan-sharp-edges.md|([0-9]+)-byte critical cap|REJECT"
  "plugins/soleur/skills/plan/references/plan-sharp-edges.md|per-rule ([0-9]+)-byte cap|PER_RULE_CAP"
