...
# AGENTS pre-commit-hook tests (#3684).
run_suite "scripts/lint-agents-rule-budget" bash scripts/lint-agents-rule-budget.test.sh
run_suite "scripts/lint-agents-enforcement-tags" bash scripts/lint-agents-enforcement-tags.test.sh
