...
While a Corporate CLA **of yours** is in flight -- and only then -- your pull request carries the state **"CCLA in progress -- maintainer action, not yours"**. It is reviewed and merged on its merits in the meantime: that paperwork is what we owe your employer, not a task assigned to you. None of this applies if you are contributing your own work on your own time; then the individual CLA is the whole ask.
