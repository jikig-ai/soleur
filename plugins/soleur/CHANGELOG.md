...
- GitHub Pages documentation site at `plugins/soleur/docs/` with 7 pages (index, agents, commands, skills, mcp-servers, changelog, getting-started)
- Custom 404 error page, sitemap.xml, robots.txt, and .nojekyll for GitHub Pages
- CSS design system with OKLCH color tokens, dark mode support, and responsive layout
- Deploy workflow validation step to verify all required HTML pages exist before deployment
