...
Use this template when adding a pattern to `knowledge-base/features/learnings/patterns/critical-patterns.md`:
...
**Documented in:** `knowledge-base/features/learnings/[category]/[filename].md`
