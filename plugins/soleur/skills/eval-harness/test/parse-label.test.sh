...
loadenum "file://enums/go-routes.json"     11 "fix" "loadEnum file:// literal ref (one promptfoo shape)"
loadenum "file://enums/triage-levels.json" 3 "P1"  "loadEnum file:// triage-levels"
loadenum "enums/go-routes.json"            11 "fix" "loadEnum bare relative path"
...
loadenum '["fix","drain","drain-prs","clo-attestation","review","legal-threshold","incident","implement","questionnaire","glossary","default"]' 11 "fix" "loadEnum JSON-array-text contents (promptfoo file:// resolved-contents shape)"
