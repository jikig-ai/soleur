...
**Step 2:** Spawn the soleur:engineering:discovery:functional-discovery agent.
...
```
Task soleur:engineering:discovery:functional-discovery: "Feature description: [feature_description text].
...
- If soleur:engineering:discovery:functional-discovery failed (network errors): continue silently. Discovery must never block planning.
