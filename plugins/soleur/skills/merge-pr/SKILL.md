...
- `knowledge-base/features/brainstorms/` (excluding `archive/` paths)
- `knowledge-base/features/plans/` (excluding `archive/` paths)
- `knowledge-base/features/specs/feat-<feature>/`
