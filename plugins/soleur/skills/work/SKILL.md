...
2. If the branch starts with `feat-`, read `knowledge-base/features/specs/<branch-name>/tasks.md` if it exists
...
4. Read `knowledge-base/features/specs/feat-<name>/tasks.md` if it exists - use as work checklist alongside TodoWrite
