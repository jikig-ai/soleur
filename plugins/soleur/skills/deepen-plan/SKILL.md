...
1. Check for recent plans: `ls -la knowledge-base/features/plans/`
2. Ask the user: "Which plan would you like to deepen? Please provide the path (e.g., `knowledge-base/features/plans/2026-01-15-feat-my-feature-plan.md`)."
...
```
knowledge-base/features/learnings/           <-- PRIMARY: Project-level learnings (created by soleur:compound)
├── performance-issues/
│   └── *.md
├── debugging-patterns/
│   └── *.md
...
head -20 knowledge-base/features/learnings/**/*.md
```
