...
describe("workflow-fidelity contract", () => {
  ...
  test("handoff skills include plan, work, review, compound", () => {
  ...
  test("mandatorySuccessors maps lifecycle handoffs", () => {
    ...
    expect(mandatorySuccessors("ship")).toEqual([]);
  });

  test("grok routing instructions include lifecycle fidelity block", () => {
...
describe("workflow-fidelity sentinel markers in skills", () => {
  ...
  test("AGENTS.core.md pins pipeline and lifecycle hard rules", () => {
