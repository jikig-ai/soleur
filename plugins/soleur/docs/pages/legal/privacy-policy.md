...
> **Related documents:** This Privacy Policy should be read alongside the companion [Cookie Policy](/pages/legal/cookie-policy.html) for detailed information about cookies used by the Docs Site (GitHub Pages) and the [GDPR Policy](/pages/legal/gdpr-policy.html) for detailed GDPR-specific disclosures.
