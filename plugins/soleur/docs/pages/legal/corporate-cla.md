...
<section class="page-hero">
  <div class="container">
    <h1>Corporate Contributor License Agreement</h1>
    <p>Version 1.0 -- Effective February 26, 2026</p>
  </div>
</section>
...
**Where the signature record is kept.** Two copies are made. One is written to the public `cla-signatures` branch of the Project's GitHub repository, where anyone can read it. The other is written to an **off-site evidence archive**: a storage bucket operated for Us by **Cloudflare, Inc.**, a company established in the **United States**. Making the record -- which includes the authorised signatory's name and corporate email address -- available to Cloudflare is a transfer to a third country under Chapter V of the GDPR, whatever the physical location of the storage. That transfer is made under Cloudflare's certification to the **EU-US Data Privacy Framework** (European Commission adequacy decision C(2023) 4745), the **Standard Contractual Clauses**, and **Global CBPR**. To obtain a copy of the safeguards We rely on, write to <legal@jikigai.com>.

**How long it is kept.** The signature record is retained **indefinitely**, on both copies. The off-site archive additionally carries a ten (10) year write-once retention **floor** -- a minimum period during which the record cannot be deleted through the ordinary write path -- and nothing removes the record when that period expires. Retention is indefinite because the licence You grant is irrevocable and has no end date, so the evidence that You granted it must remain available for as long as the grant can be relied on or disputed.

**Asking Us to erase it.** The authorised signatory may ask Us to erase the signature record at any time, including during the ten-year floor: We operate a controlled administrator procedure that can remove the archived object and leave a permanent tombstone in its place. Two things do not change if We do. First, the licence You granted survives the erasure and continues in full effect for Contributions already made. Second, under Article 17(3)(e) We may decline to erase a record that is necessary for the establishment, exercise, or defence of legal claims regarding the Contributions; where that applies, We will say so and why.

See the [Privacy Policy](/legal/privacy-policy/) Sections 4.5, 5.11 and 10, and the [GDPR Policy](/legal/gdpr-policy/) Sections 3.4 and 6, for the full retention, international-transfer and data-subject-rights detail.
