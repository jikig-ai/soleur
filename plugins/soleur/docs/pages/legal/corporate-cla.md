...
The lawful basis for processing the signature record is **legitimate interest** under GDPR Article 6(1)(f) -- maintaining an enforceable record of contributor IP license grants to defend the integrity of the Project's licensing framework. The signature record is retained **indefinitely**. The off-site evidence archive carries a ten (10) year write-once retention **floor** -- a minimum period during which the record cannot be deleted -- and nothing removes it when that period expires. Retention is indefinite because the licence You grant is irrevocable and has no end date, so the evidence that You granted it must remain available for as long as the grant can be relied on or disputed. Deletion of the signature record may be requested; the grant survives the deletion. *(Corrected 2026-08-20, ref #7624: this sentence previously stated a ten (10) year retention period, which understated it -- ten years is a floor, not a ceiling.)* Under Article 17(3)(e), the right to erasure does not apply to data necessary for the establishment, exercise, or defense of legal claims regarding the Contributions; see the [Privacy Policy](/legal/privacy-policy/) and [GDPR Policy](/legal/gdpr-policy/) for details.
