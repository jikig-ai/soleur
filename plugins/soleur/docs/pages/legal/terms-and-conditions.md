...
- **"Plugin"** refers to the Soleur plugin for supported AI coding CLIs (including Claude Code and Grok Build), including all agents, skills, commands, configuration files, and knowledge-base components.
...
Soleur is a locally installed plugin for supported AI coding CLIs (including Claude Code and Grok Build) that provides:
