...
- **Right to Object (Article 21):** Object to processing of personal data. The legal basis depends on the activity: contract performance (Article 6(1)(b)) for the Web Platform services you sign up for, where this right applies primarily to processing beyond strict contractual necessity; and legitimate interests (Article 6(1)(f)) for the owner-curated beta-tester / prospect CRM, where you may object at any time and we must stop unless we demonstrate compelling legitimate grounds overriding your interests.
