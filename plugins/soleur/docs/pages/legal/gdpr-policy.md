...
### 3.11 Agent-assisted, human-approved outbound email to professional contacts (mail.jikigai.com)

For the agent-assisted, **human-approval-gated** 1:1 outbound cold email used for the founder's outreach, sent from the dedicated subdomain `mail.jikigai.com` via Resend (Privacy Policy Section 4.14; Article 30 register Processing Activity 28). This is the **outbound counterpart** to Section 3.10 and overturns the send-authority deferral recorded in the 2026-06-11 inbound LIA:
