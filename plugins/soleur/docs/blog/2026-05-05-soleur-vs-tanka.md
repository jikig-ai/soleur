...
seoTitle: "Soleur vs. Tanka: AI Co-Founder Comparison — Memory Platform vs. Cross-Domain Business Intelligence"
date: 2026-05-05
...
Soleur: executing work across {{ stats.departments }} business domains with agents that compound organizational knowledge with every session.

### Agent Scope

Tanka: Fundraising Agent (September 2025), with GTM, hiring, and product management agents in the roadmap Agent Store.

Soleur: {{ stats.agents }} agents across {{ stats.departments }} departments — engineering, marketing, legal, finance, operations, product, sales, support, and community — running in the founder's development environment with access to the full compounding knowledge base.
