...
export const MANIFEST: ManifestEntry[] = [
  ...
  },
  {
    ...
    // period+grace-10 is recorded in ADR-117's 2026-08-20 amendment), because a 230s poll that
    ...
    // once #7462 restores the host this monitor arms PROBABILISTICALLY — expected ~2 days at the
    // measured 2.71 merge-applies/day, not on the next apply.
    //
    ...
    // which is the false-alarm this declaration exists to prevent — and this row is the ONLY
    // observer of that arming, because the reconcile job is exempted from this monitor by name.
