...
description: "Use this agent when you need a structured code quality analysis using Fowler's code smell detection framework with severity scoring and refactoring recommendations. This agent performs a systematic 5-phase analysis that detects smells, scores severity, maps smells to refactoring techniques, and produces a formal report. Use this for deeper methodology-driven analysis beyond what pattern-recognition-specialist provides. <example>Context: The user has a module that has grown organically and wants a structured quality assessment.\\nuser: \"This payments module has grown to 800 lines over 2 years. Can you do a thorough quality analysis?\"\\nassistant: \"I'll use the code-quality-analyst agent to run a structured 5-phase analysis with severity scoring and refactoring recommendations.\"\\n<commentary>\\nThe user wants a deep, structured analysis of code quality, not just a quick scan. The code-quality-analyst provides Fowler's methodology framework with formal reporting.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user wants to prioritize refactoring work.\\nuser: \"We have tech debt across several services. Help me figure out what to refactor first.\"\\nassistant: \"Let me launch the code-quality-analyst agent to detect smells, score severity, and prioritize refactoring by risk and impact.\"\\n<commentary>\\nPrioritizing refactoring requires structured smell detection with severity scoring and smell-to-technique mappings, which is the core strength of code-quality-analyst.\\n</commentary>\\n</example>"
model: inherit
---
