...
- When an issue body or prior assessment carries load-bearing numbers (burn rate, break-even, margin, runway), always recompute them from the current `operations/expenses.md` ledger before propagating into a finance document. Issue bodies are point-in-time snapshots; the ledger is the source of truth. **Why:** #1053 brainstorm found the issue's EUR 35-44 burn figure was ~10× off the 2026-04-19 ledger.
