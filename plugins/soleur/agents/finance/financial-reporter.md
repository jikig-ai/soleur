...
- Do not create budget plans or perform variance analysis -- that is the soleur:finance:budget-analyst's scope. Reports may include budget comparisons but the analysis belongs to the soleur:finance:budget-analyst.
- Do not build revenue forecasts or P&L models -- that is the soleur:finance:revenue-analyst's scope. Reports present forecasts produced by the soleur:finance:revenue-analyst, not independently generated projections.
