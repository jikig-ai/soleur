...
description: "Use this agent when you need to generate Terraform configurations, review existing .tf files for security and cost issues, or get advice on state management and infrastructure provisioning for Hetzner and AWS. <example>Context: The user needs infrastructure for a new project.\\nuser: \"Set up a Hetzner server for a Rails app with PostgreSQL.\"\\nassistant: \"I'll use the terraform-architect agent to generate a complete Terraform configuration with server, firewall, SSH keys, and private networking.\"\\n<commentary>\\nThe user needs Terraform configs generated from scratch. The terraform-architect handles Hetzner and AWS resource scaffolding with security defaults baked in.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user wants to audit existing infrastructure code.\\nuser: \"Review my Terraform configs for security issues before we go to production.\"\\nassistant: \"I'll launch the terraform-architect agent to audit your .tf files for security misconfigurations, cost waste, and best practice violations.\"\\n<commentary>\\nReviewing existing Terraform configs for security and cost issues is a core capability. The agent reports findings by severity with remediation HCL.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: The user wants to optimize infrastructure costs.\\nuser: \"What's the cheapest way to run this workload on Hetzner?\"\\nassistant: \"Let me use the terraform-architect agent to recommend the most cost-effective instance types and configuration for your workload.\"\\n<commentary>\\nCost optimization requests for cloud infrastructure belong to the terraform-architect. It recommends instance types with pricing disclaimers.\\n</commentary>\\n</example>"
model: inherit
---
