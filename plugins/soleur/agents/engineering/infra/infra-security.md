...
**Detailed workflow:** For the complete autonomous sequence including common blockers, see `knowledge-base/features/learnings/integration-issues/2026-02-16-github-pages-cloudflare-wiring-workflow.md`.
