locals {
  ...
  host_script_files = [
    ...
    # the HOST base image (NOT the app image cosign verifies — so no circular trust, ADR-085)
...
# the ephemeral cosign verifier (ADR-085). Public trust material, not a secret.
