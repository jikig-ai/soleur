...
# census FALSIFIED (ADR-159). The measured conclusion is retained unchanged and is deliberately
# not re-derived here:
...
# inferred from the "branch configs inherit the root" premise that #7159 falsified (ADR-159,
