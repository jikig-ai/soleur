...
locals {
  ...
  # standby (ADR-143) — a different host from the retired fsn1 .11 (#6538). This literal is
  ...
  #
  # AC6 / SEQUENCING (ADR-143 3.3 / #6608): this config change is SAFE on the merge-apply — the
