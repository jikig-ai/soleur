...
#
# THE #6575 DELETION FLAW, AND THE FIX (ADR-143 D3). The original gate REQUIRED web-2 in the
...
# this env-driven runtime gate so the two never drift (ADR-143 D3 / CTO ruling 2b). SCOPE CAVEATS:
...
#
#   Top-guard (ADR-143 D3): SOLEUR_WEB2_SERVING_WEIGHT (explicit integer ≥0; absent/non-int/negative
...
# =============================================================================
# TOP-GUARD — web-2 serving-weight / rotation membership (ADR-143 D3 polarity fix)
# =============================================================================
