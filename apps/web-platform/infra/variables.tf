...
variable "web_hosts" {
  ...
  # web-2 RE-ADDED 2026-07-24 as a FRESH cattle out-of-band standby (ADR-141, #6459) — a
  ...
  # (ADR-141 live stock probe 2026-07-24), cpx32 is the orderable 4c/8g x86 successor. It reuses
  # the freed 10.0.1.11 address. web-2 is OUT-OF-BAND (serving-weight 0, ADR-141 D2): NOT in the
  ...
  # Keys are IMMUTABLE (moved-block for_each; never rename web-1 — 29 refs / 6 files, ADR-141 D4).
  default = {
