...
into the ephemeral cosign verifier (`ci-deploy.sh` `verify_image_signature`, ADR-087)
...
the deliberate trade-off of an air-gapped root (security-sentinel HIGH #2, ADR-087).
