...
{ printf 'locals {\n  decoy = %s\nresource "hcloud_server" "inngest" {\n  firewall_ids = [hcloud_firewall.inngest.id]\n}\nEOT\n}\n\n' '<''<-EOT'; cat "$_g1_m9/inngest-host.tf"; } > "$_g1_m9/x" && mv "$_g1_m9/x" "$_g1_m9/inngest-host.tf"
