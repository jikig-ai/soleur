...
-- =====================================================================
-- 3b. accept_workspace_invitation — reject revoked invites (FR4)
--
-- The token-lookup path is the PRESENTATION gate; this is the MUTATION
-- gate. A holder of the raw token can POST /api/workspace/accept-invite
-- with the invitation id directly (bypassing lookup_invitation_by_token),
-- so the revoked-state check MUST live here too or a cancelled invite
-- remains acceptable. Re-issues the 075 body verbatim + a revoked arm
-- after the declined_at check.
-- =====================================================================
