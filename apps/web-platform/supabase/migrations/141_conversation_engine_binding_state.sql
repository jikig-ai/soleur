-- 141_conversation_engine_binding_state.sql
-- Durable state distinguishes pre-engine legacy conversations from rows whose
-- binding is still being created or failed after conversation insertion.
