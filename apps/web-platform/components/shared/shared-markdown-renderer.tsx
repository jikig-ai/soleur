...
/**
 * Markdown renderer for shared (public) documents.
 * Identical to the authenticated MarkdownRenderer but adds rel="nofollow"
 * to all outbound links to prevent SEO manipulation via shared documents.
 */
...
export function SharedMarkdownRenderer({ content }: { content: string }) {
  return (
    <Markdown
