...
export const ROUTINE_METADATA: Record<string, RoutineMeta> = {
  ...
  "cron-supabase-advisor-scan": { description: "Nightly gate asserting no table in a Supabase public schema is missing row-level security.", domain: "Engineering", ownerRole: "CTO", scheduleLabel: "Daily 03:37 UTC", manualTrigger: "allowed" },
