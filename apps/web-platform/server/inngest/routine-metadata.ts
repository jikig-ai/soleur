...
export const ROUTINE_METADATA: Record<string, RoutineMeta> = {
  ...
  "cron-inngest-config-drift": { description: "Compares the Inngest host's applied config digest vs the promoted pointer and alarms on drift (ADR-134); dormant until the #6178 cutover.", domain: "Engineering", ownerRole: "CTO", scheduleLabel: "Dormant until #6178 cutover (event-only)", manualTrigger: "confirm" },
