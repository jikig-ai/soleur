...
// MIRRORED-NOT-PAGED, deliberately: the eight SOLEUR_*_HALT families (#7450, #7898, #7947, #7941, #8289).
//
...
// unresolvable). Same shape as the seven below: a refusal that must reach a sink, and a dominant
// cause (a customer's plugin layout) that is not an operator page.
//
// The seven below are the secret gates' fail-closed refusals — `incident`, `legal-generate`,
