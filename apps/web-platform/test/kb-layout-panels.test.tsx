...
describe("KbLayout — resizable panels", () => {
  async function renderLayout() {
    ...
    return render(
      <FeatureFlagProvider flags={{ "kb-chat-sidebar": true, "dev-signin": false, "team-workspace-invite": false, "byok-delegations": false, "c4-visualizer": false, "debug-mode": false, "c4-edit": false, "command-palette": false, support: false, "support-live": false, "guided-tour": false, "codex-engine": false }}>
        <KbLayout>
