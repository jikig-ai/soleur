...
describe("KbLayout — resizable panels", () => {
  async function renderLayout() {
    ...
    return render(
      <FeatureFlagProvider flags={{ "kb-chat-sidebar": true, "dev-signin": false, "team-workspace-invite": false, "byok-delegations": false, "c4-visualizer": false, "debug-mode": false }}>
        <KbLayout>
