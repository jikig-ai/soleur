...
describe("FeatureFlagProvider + useFeatureFlag", () => {
  test("returns true for a flag set true in the snapshot", () => {
    render(
      <FeatureFlagProvider flags={{ "dev-signin": false, "team-workspace-invite": false, "byok-delegations": false, "kb-chat-sidebar": true, "c4-visualizer": false, "debug-mode": false, "c4-edit": false, "command-palette": false, support: false, "guided-tour": false }}>
  ...
  test("returns false for a flag set false in the snapshot", () => {
    render(
      <FeatureFlagProvider flags={{ "dev-signin": false, "team-workspace-invite": false, "byok-delegations": false, "kb-chat-sidebar": false, "c4-visualizer": false, "debug-mode": false, "c4-edit": false, "command-palette": false, support: false, "guided-tour": false }}>
        <Probe name="kb-chat-sidebar" />
      </FeatureFlagProvider>,
    );
