...
describe("Settings sidebar collapse", () => {
  ...
  // ⌘B is now owned solely by (dashboard)/layout.tsx (AC5); the settings
  // sub-nav no longer registers its own keydown handler. The ⌘B behavior is
  // covered end-to-end in dashboard-sidebar-collapse.test.tsx. Click-driven
  // collapse (above) is retained.
